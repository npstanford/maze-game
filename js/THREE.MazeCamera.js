...
THREE.MazeCamera = function ( object, domElement ) {
	...
	this.update = function( delta , terrainInfo) {
		...
		if ( this.freeze ) {
			...
			//set the height of the camera relative to the current ground
			this.camera.position.y = terrainInfo.elevation;
			
			//perform collision detection
			//take the current x and z coordinates and find where in the max we are
			//look at the maze object, and find out where the walls are. 
